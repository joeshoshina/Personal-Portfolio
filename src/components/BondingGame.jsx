          ...
          <div className="BottomBox">
            <div className="bottom-paragraphs">
              ...
              <p className="BottomDescription">
                ...
                gained skills in the React ecosystem (React, Vite, JSX) and best
                practices for component structure and state management using
                hooks like useState and useEffect. I learned to structure and
                update objects in state efficiently and how to implement data
                structures like stacks in a React-friendly way. Additionally, I
                gained confidence in using Git for version control, styling with
                CSS and TailwindCSS, and breaking down tasks into smaller,
                manageable steps to build scalable solutions.
              </p>
            </div>
            ...
            <div className="bottom-paragraphs">
              ...
              <p className="BottomDescription">
                <ul>
                  <li>
                    User-Generated Prompts: Allow users to add their own prompts
                    into the card stack.
                  </li>
                  <li>
                    Card Stack Visualization: Display a stack of cards, similar
                    to a physical deck, with cards decreasing as they are used.
                  </li>
                  <li>
                    Friend-Specific Card Decks: Add functionality to switch
                    between card decks tailored for couples or friends, ensuring
                    questions are appropriate for each group.
                  </li>
                </ul>
              </p>
            </div>
