              ...
              <div className="TopOutline">
                <div className="top-paragraphs">
                  ...
                  <p className="TopDescription">
                    ...
                    meaningful questions without feeling vulnerable—using the
                    card format as a lighthearted excuse to explore deeper
                    topics. The game encourages connection, strengthens
                    ...
                    are shuffled and presented as a randomized stack.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="BottomOutline">
                <div className="bottom-paragraphs">
                  ...
                  <p className="BottomDescription">
                    ...
                    implement data structures like stacks in a React-friendly
                    way. Additionally, I gained confidence in using Git for
                    version control, styling with CSS and TailwindCSS, and
                    breaking down tasks into smaller, manageable steps to build
                    scalable solutions.
                  </p>
                </div>
              </div>
                  ...
                  <p className="BottomDescription">
                    <ul>
                      ...
                      <li>
                        ...
                        similar to a physical deck, with cards decreasing as
                        they are used.
                      </li>
                      <li>
