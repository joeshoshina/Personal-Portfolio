              ...
              <div className="TopOutline">
                <div className="top-paragraphs">
                  ...
                  <p className="TopDescription">
                    ...
                    movies based on the current date. By integrating the TMDB
                    API, the app ensures the trending list is always up to date.
                    This project was built as a learning experience to deepen my
              ...
              <div className="BottomOutline">
                <div className="bottom-paragraphs">
                  ...
                  <p className="BottomDescription">
                    This project helped me reinforce my skills in React, Vite,
                    and JSX, while also learning Tailwind CSS and how its
                ...
                <div className="bottom-paragraphs">
                  ...
                  <p className="BottomDescription">
                    <ul>
                      ...
                      <li>
                        Detailed Movie View: I want to enhance the search
                        results by allowing users to interact with a movie
                        thumbnail to view all available details provided by the
                        TMDB API. Currently, only the thumbnail and basic info
                        like the rating are shown.
                      </li>
                      <li>
                        Search History or Recent Searches: Let users see a list
                        of their recent searches for convenience and quicker
                        navigation.
                      </li>
                    </ul>
                  </p>
